          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border-2 border-[#d4b896] hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <a
                    href="tel:9769045555"
                    className="text-lg sm:text-xl font-semibold text-[#0a4d5c] hover:text-[#d4b896] transition-colors block"
                  >
                    +91 9769045555
                  </a>
                </div>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border-2 border-[#d4b896] hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <a
                    href="mailto:vihaarabusinessbay@gmail.com"
                    className="text-sm sm:text-base md:text-lg font-semibold text-[#0a4d5c] hover:text-[#d4b896] transition-colors break-all block"
                  >
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg border-2 border-[#d4b896] hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0 text-left">
                  <p className="text-xs sm:text-sm text-[#0a4d5c] font-semibold mb-2">
                    Sales Lounge
                  </p>
                  <p className="text-sm sm:text-base text-gray-800 leading-relaxed">
                    W69, Opp. Aurindam Hospital, Near DNS Bank,

...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-white border-t-2 border-[#d4b896] text-gray-700"
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3
              className="text-[#0a4d5c] text-lg font-bold mb-4 uppercase"
          ...
          <div className="space-y-4">
            ...
            <address className="not-italic space-y-3 text-sm">
              {/* Sales Lounge */}
              <div>
                <p className="text-[#0a4d5c] font-semibold mb-2">
                  Sales Lounge:
                </p>
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600">
                    {siteMeta.contact.salesLounge.street},{" "}
                    {siteMeta.contact.salesLounge.city}, Dist.{" "}
                    {siteMeta.contact.salesLounge.district},{" "}
                    {siteMeta.contact.salesLounge.country}
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600">
                    {siteMeta.contact.corporateOffice.street},{" "}
                    {siteMeta.contact.corporateOffice.city} –{" "}
                    {siteMeta.contact.corporateOffice.postalCode},{" "}
                    {siteMeta.contact.corporateOffice.country}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                <svg
                  className="w-5 h-5 text-[#d4b896] flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://youtu.be/Kd9Ng1xGyoA?si=pQw5lQZQWMrG2yKI"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-[#d4b896] transition-colors"

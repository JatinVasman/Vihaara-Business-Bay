...
const floorplans = [
  ...
  },
  {
    ...
    floors: "Ground Level",
    thumbnail: "/assets/floorplans/ground-floor.jpeg",
    features: [
      "Spacious Floor Plates With Modular Layouts",
      "Smart Energy & Water-saving Provisions",
    ],
    shops: [{ no: "SHOP-1", area: "1160.25 sq.ft " }],
  },
  {
    id: 3,
    ...
    features: ["Flexible Office Layouts", "High-Quality Commercial Spaces"],
    offices: [
  ...
  },
  {
    ...
    features: ["Premium Rooftop Amenities", "Spacious Restaurant & Lobby Area"],
    areas: [{ name: "RESTAURANT + LOBBY", area: "3961.25" }],
  },
];
              ...
              <div className="grid lg:grid-cols-3 gap-6 p-6">
                ...
                <div className="lg:col-span-2">
                  <div
                    ...
                    tabIndex={0}
                    onKeyPress={(e) =>
                      e.key === "Enter" && setSelectedPlan(plan)
                    }
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h3
                      className="text-2xl font-semibold text-[#0a4d5c] mb-2 uppercase"
                      style={{ fontFamily: "serif" }}
                    >
                      {plan.title}
                    </h3>

                    <p className="text-gray-600 text-sm mb-4">{plan.floors}</p>
                            ...
                            <tbody>
                              {plan.shops.map((shop, idx) => (
                                ...
                                >
                                  ...
                                  <td className="py-2 text-right text-gray-900 font-medium text-xs">
                                    {shop.area}
                                  </td>
                                </tr>
                              ))}
          ...
          {selectedPlan && (
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 gap-4">
                ...
                <h3
                  id="lightbox-title"
                  className="hidden md:block text-lg text-white font-semibold flex-1 text-center"
                >
                  {selectedPlan.title}
                </h3>

        ...
        >
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p>
                A new-age commercial address where{" "}
                <strong className="text-[#0a4d5c]">
                  ambition meets infrastructure
                </strong>
                . Strategically located in the rapidly emerging commercial node
                of Dombivli, Vihaara Business Bay is more than a business space;
                it's a thriving ecosystem designed for productivity, comfort and
                success.
              </p>
              ...
              <p>
                Whether you're a{" "}
                <strong className="text-[#0a4d5c]">
                  startup, MSME or established enterprise
                </strong>
                , Vihaara Business Bay provides the foundation for sustainable
                growth in one of Mumbai's most well-connected suburbs.
              </p>
            </div>
